...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $conn->prepare("UPDATE tbl_student1 SET first_name = :first_name, middle_name = :middle_name, last_name = :last_name, student_course = :student_course, year_level = :year_level, student_status = :student_status WHERE tbl_student_id = :tbl_student_id");
