...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $sql = "INSERT INTO tbl_student (section, first_name, middle_name, last_name, year_level, student_course, student_status, student_no, qr_code) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt->rowCount() > 0) {
            ...
            header("Location: http://localhost/htdocfinals2/infomanagementadmin.php");
            exit();
        } else {
