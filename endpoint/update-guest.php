...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $requiredFields = ['update_student_fName', 'update_student_mName', 'update_student_lName', 'update_student_course', 'update_tbl_student_id'];
    ...
    try {
        $stmt = $conn->prepare("UPDATE tbl_student SET first_name = :first_name, middle_name = :middle_name, last_name = :last_name, student_course = :student_course WHERE tbl_student_id = :tbl_student_id");
