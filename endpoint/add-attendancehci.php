...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['qr_code'])) {
        ...
        $selectStmt = $conn->prepare("SELECT tbl_student_id FROM tbl_student1 WHERE qr_code = :qr_code");
        ...
        try {
            $stmt = $conn->prepare("INSERT INTO tbl_attendance1 (tbl_student_id, time_in) VALUES (:tbl_student_id, :time_in)");
            ...
            header("Location: http://localhost/htdocfinals2/indexhci.php");
