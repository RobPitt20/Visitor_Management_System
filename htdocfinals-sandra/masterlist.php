...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="./index.php">QR Scanner  |</a>
                </li>
                <li class="nav-item">
    ...
    <div class="main">
        <div class="sidebar">
            <h2 style="font-size: 24px;">Welcome Admin</h2>
            <ul>
                <li><a href="./subject.php">Subjects</a></li>
                <li><a href="./calendar.php">Time and Calendar</a></li>
        ...
        <div class="main_content">
            <div class="student-container">
                <div class="student-list">
                    <div class="title">
                        <h1 style="font-size: 36px;">List of Students</h1>
