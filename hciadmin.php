...
<head>
    ...
    <style>
        ...
        * {
         ...
         body {
        background-color: darkslategray; /* Change background color to green */
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="./subjectadmin.php">Subjects  |</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./subject1.php"> user page  |</a>
                </li>
        ...
        <div class="main_content">
            <div class="student-container">
                <div class="student-list">
                    <div class="title">
                        <h1 style="font-size: 36px;">Human Computer Interaction</h1>
        ...
        <table class="table text-center table-sm" id="studentTable">
            ...
            <tbody>
                ...
                <?php 
                    ...
                    $stmt = $conn->prepare("SELECT * FROM tbl_student1");
                    $stmt->execute();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="./endpoint/add-studenthciadmin.php" method="POST">
...
<div class="modal fade" id="updateStudentModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="updateStudent" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="./endpoint/update-studenthci.php" method="POST">
                    <div class="form-group">
    ...
    $("#updateStudentcourse").val(updateStudentCourse);
        ...
        function deleteStudent(id) {
            if (confirm("Do you want to delete this student?")) {
                window.location = "./endpoint/delete-studenthci.php?student=" + id;
            }
        }
