        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="./index.php">Qr Scanner<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="./infomanagement.php">List of Students</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="attendance-container row">
            <div class="qr-container col-4">
                ...
                <div class="qr-detected-container" style="display: none;">
                    <form id="attendanceForm" action="./endpoint/add-attendanceIM.php" method="POST">
            ...
            <div class="attendance-list">
                ...
                <div class="button-group">
                    <button class="btn btn-danger" onclick="deleteAllAttendance()">Delete All</button>
                    <button class="btn btn-success"  color="green" onclick="window.location.href='export-attendanceIM.php'">Export to Excel</button>
    ...
    <script>
        ...
        function deleteAttendance(id) {
            if (confirm("Do you want to remove this attendance?")) {
                window.location = "./endpoint/delete-attendanceIM.php?attendance=" + id;
            }
        }

        function deleteAllAttendance() {
            if (confirm("Do you want to remove all attendances?")) {
                window.location = "./endpoint/delete-all-attendanceIM.php";
            }
        }
    </script>
</body>
